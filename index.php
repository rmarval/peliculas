...
<?php
              ...
              ?>
                 ...
                 <tr border="0">
                   <td width="200" colspan="2" height="30" class="formulario" ><a class="textoFormulario" href="#" onClick="document.menu.pagina.value='buscarPeliculas.php';document.menu.submit()">Busqueda de pel�culas</a> </td>
                 </tr>
              <?php
              ...
              ?>
                       <tr border="0">
                          <td width="200" height="30" colspan="2" class="formulario" ><a class="textoFormulario" href="#" onClick="document.menu.pagina.value='insertarPelicula.php';document.menu.submit()">Alta de pel�culas </a></td>
                       </tr>
                       <tr border="0">
                           <td width="200" height="30" colspan="2" class="formulario"><a class="textoFormulario" href="#" onClick="document.menu.pagina.value='eliminarPeliculas.php';document.menu.submit()">Eliminar pel�culas </a></td>
                       </tr>
              ...
              ?>
                 ...
                 <tr border="0">
                     <td width="200" height="30" colspan="2" class="formulario"><a  class="textoFormulario" href="#" onClick="document.menu.pagina.value='cerrarSesion.php';document.menu.submit()">Cerrar Sesi�n </a> </td>
                 </tr>
              <?php
         ...
         <td width="750"  class="Derecha"  align="center">
            <table cellspacing="0" border="0" height="500">
                <tr height="80">
                    <td class="logo" align="center" >Pel�culas</td>
                </tr>
                 <tr height="500">
